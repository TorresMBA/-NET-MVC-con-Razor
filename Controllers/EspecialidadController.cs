...
namespace WebAppMVC.Controllers
{
    public class EspecialidadController : Controller
    {
        ...
        [HttpPost]
        public async Task<ActionResult> Create([Bind("Id, Descripcion")] Especialidad especialidad)
        {
        ...
        public async Task<IActionResult> Delete(int? id)
        {
            ...
            var especialidad = await _context.Especialidad.FirstOrDefaultAsync(x => x.Id == id);
